...
```mermaid
graph LR
    A["visbruno (Informação/Notas)"] --> C["A SÍNTESE (Luxo Informativo)"]
    B["visalta (Fotografia de Luxo)"] --> C
```
...
[catalogo_perfumes.md](file:///C:/Users/odeao/OneDrive/Desktop/brem/Bruno/Decante/catalogo_perfumes.md)
